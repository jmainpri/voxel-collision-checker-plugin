...
// Collision points
std::vector<distance_field::CollisionPoint> createCollionPointsForRobot( OpenRAVE::EnvironmentBasePtr penv, OpenRAVE::RobotBasePtr robot, const std::vector<std::pair<bool,float> >& radii, bool use_second_joint=false );
